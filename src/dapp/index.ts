...
// Legacy business pages may still request a signature. Demo mode never opens a wallet.
export async function getSign(_message: string): Promise<{ signature: string; timestamp: number } | false> {
    return false
}
